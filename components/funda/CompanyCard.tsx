...
function CompanyCard({company}: CompanyCardProps) {
    ...
    return (
        <>
            <div className={'rounded-2xl bg-white dark:bg-gray-800 shadow-md dark:shadow-gray-900/50 hover:shadow-lg dark:hover:shadow-gray-900/70 transition-shadow overflow-hidden p-5 relative cursor-pointer'}
