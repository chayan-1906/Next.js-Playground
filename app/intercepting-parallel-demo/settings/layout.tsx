...
// Separate component for tab navigation that uses usePathname
    ...
    return (
        <div className={'min-h-screen bg-gray-50 dark:bg-gray-950 p-8'}>
            <div className={'max-w-7xl mx-auto'}>
                ...
                {/* Tab Navigation - wrapped in Suspense for CSR bailout */}
                <Suspense fallback={<div className={'mb-8 h-12 bg-gray-100 dark:bg-gray-800 rounded animate-pulse'}/>}>
                    <TabNavigation/>
                </Suspense>
