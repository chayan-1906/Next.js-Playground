        ...
        <div className={'max-w-7xl mx-auto flex flex-col p-6 gap-3 font-sans'}>
            <div className={'flex justify-between items-center'}>
                ...
                <form action={revalidateProducts}>
                    <button className={'w-full px-4 py-3 rounded-xl bg-emerald-500 hover:bg-emerald-600 transition text-white font-medium cursor-pointer'}>Revalidate Products</button>
                </form>
            </div>
...
async function ProductList() {
    ...
    return (
        <div>
            <p className={'text-sm text-gray-500 mb-4'}>Cached at: {cachedAt}</p>
