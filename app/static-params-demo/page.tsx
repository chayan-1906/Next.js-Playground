    ...
    return (
        <div className={'bg-white min-h-screen'}>
            <div className={'container mx-auto px-4 py-8'}>
                <h1 className={'text-4xl font-bold mb-4 text-gray-900'}>generateStaticParams & dynamicParams</h1>
                ...
                <div className={'space-y-4'}>
                    ...
                    <p className={'text-gray-700'}>In our example, we will pre-generate pages for products with IDs 1 through 6</p>
                    <ul className={'list-disc list-inside space-y-2'}>
                        <li className={'text-blue-600'}>
                            <Link href={routes.staticParamsProductDetailsDemo('1')} className={'hover:underline'}>
                                Product 1 (Statically Generated)
                            </Link>
                        </li>
                        <li className={'text-blue-600'}>
                            <Link href={routes.staticParamsProductDetailsDemo('6')} className={'hover:underline'}>
                                Product 6 (Statically Generated)
                            </Link>
                        </li>
                        <li className={'text-red-600'}>
                            <Link href={routes.staticParamsProductDetailsDemo('7')} className={'hover:underline'}>
                                Product 7 (Not Statically Generated)
                            </Link>
                        </li>
                    </ul>
                    <p className={'mt-4 text-gray-600'}>
                        Clicking the links for products 1 or 6 should be instant, as they are pre-built
                        <br/>
                        The behavior of the &quot;Product 7&quot; link will depend on our{' '}
