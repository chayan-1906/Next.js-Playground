...
function FundaPeopleError({error, reset}: FundaErrorProps) {
    useEffect(() => {
        console.error('Funda people page error:', error);
    }, [error]);
        ...
        <div className={'flex flex-col max-w-7xl mx-auto p-6 gap-6'}>
            <div className={'flex flex-col items-center justify-center min-h-[50vh] text-center'}>
                ...
                <p className={'text-gray-600 dark:text-gray-400 mb-6 max-w-md'}>
                    {'We encountered an error while loading the people data. Please try again.'}
                </p>
                {error.digest && (
...
export default FundaPeopleError;
